package com.ivblanc.api.oauth.handler;
...
import com.ivblanc.api.config.AppProperties;
...
import com.ivblanc.core.utils.CookieUtils;
...
public class OAuth2SuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
		...
		String token = jwtTokenUtil.generateToken(userRepository.findByEmail(authentication.getName()));
