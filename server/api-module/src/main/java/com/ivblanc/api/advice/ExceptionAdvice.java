package com.ivblanc.api.advice;
...
import com.ivblanc.core.exception.*;
...
public class ExceptionAdvice {
	...
	public CommonResult communicationException(HttpServletRequest request, FileUploadException e) {
		...
		return responseService.getFailResult(Integer.valueOf(getMessage("FileUploadException.code")),
			getMessage("FileUploadException.msg"));
	}
	...
	public CommonResult communicationException(HttpServletRequest request, FileNotSupportException e) {
		...
		return responseService.getFailResult(Integer.valueOf(getMessage("FileNotSupportException.code")),
			getMessage("FileNotSupportException.msg"));
	}
	...
	public CommonResult communicationException(HttpServletRequest request, FileSizeException e) {
		...
		return responseService.getFailResult(Integer.valueOf(getMessage("FileSizeException.code")),
			getMessage("FileSizeException.msg"));
	}
	...
	protected CommonResult communicationException(HttpServletRequest request, FailedException e) {
		...
		return responseService.getFailResult(Integer.valueOf(getMessage("failedException.code")),
			StringUtils.isEmpty(e.getMessage()) ? getMessage("failedException.msg") : e.getMessage());
	}
