...
class opt:
    ...
    def __init__(self):
        ...
        self.gmm_checkpoint = "gmm_final_pth"
        self.alias_checkpoint = "alias_final_pth"
        self.semantic_nc = 13
...
def main():
    ...
    load_checkpoint(seg, os.path.join("checkpoints/seg_final.pth"))
    load_checkpoint(gmm, os.path.join("checkpoints/gmm_final.pth"))
    load_checkpoint(alias, os.path.join("checkpoints/alias_final.pth"))
